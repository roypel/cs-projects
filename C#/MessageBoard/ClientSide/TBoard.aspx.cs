...
public partial class TBoard : System.Web.UI.Page
{
    ...
    protected void Delete()
    {
        ...
        {
            if  ((ds.Tables[0].Rows[i][3].ToString() != "0")&& (DateTime.Compare(Today, (DateTime.Parse(ds.Tables[0].Rows[i][3].ToString()))) > 0))
            {
