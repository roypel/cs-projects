<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SBoard.aspx.cs" Inherits="SBoard" %>
...
<body dir="rtl" style="font-family: Tahoma; background-color: #84C1FF;">
    ...
    <center>
        <table style="font-family: Tahoma; background-color: #FFFFFF" width="100%">
            <tr align="center">
                <td>
                    <asp:Label ID="lblS" runat="server" Text="לוח תלמידים" Font-Size="XX-Large"></asp:Label>
                </td>
            </tr>
            <tr align="center">
                <td>
